# Claude Code Instructions — MyHarness Project
...
> Copy patterns from `.harness/stacks/<stack-name>/CLAUDE.md` § Coding Patterns
...
## 8. Active Technologies

<!-- Updated by: bash .specify/scripts/bash/update-agent-context.sh claude -->

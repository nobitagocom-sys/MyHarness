...
**Note**: This template is filled in by the `/myharness.plan` command. See `.specify/templates/plan-template.md` for the execution workflow.
...
```text
specs/[###-feature]/
├── plan.md              # This file (/myharness.plan command output)
├── research.md          # Phase 0 output (/myharness.plan command)
├── data-model.md        # Phase 1 output (/myharness.plan command)
├── quickstart.md        # Phase 1 output (/myharness.plan command)
├── contracts/           # Phase 1 output (/myharness.plan command)
└── tasks.md             # Phase 2 output (/myharness.tasks command - NOT created by /myharness.plan)
```
